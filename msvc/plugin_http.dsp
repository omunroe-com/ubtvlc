# Microsoft Developer Studio Project File - Name="plugin_http" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Console Application" 0x0103

CFG=plugin_http - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "plugin_http.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "plugin_http.mak" CFG="plugin_http - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "plugin_http - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "plugin_http - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
# Name "plugin_http - Win32 Release"
# Name "plugin_http - Win32 Debug"
