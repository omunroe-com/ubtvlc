# Microsoft Developer Studio Project File - Name="plugin_dvdnav" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Console Application" 0x0103

CFG=plugin_dvdnav - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "plugin_dvdnav.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "plugin_dvdnav.mak" CFG="plugin_dvdnav - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "plugin_dvdnav - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "plugin_dvdnav - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
# Name "plugin_dvdnav - Win32 Release"
# Name "plugin_dvdnav - Win32 Debug"
