...
Build-Depends: debhelper (>= 7.2.3~), dh-buildinfo, gettext, liba52-0.7.4-dev, libaa1-dev, libasound2-dev (>= 0.9.0beta10a) [!kfreebsd-i386 !kfreebsd-amd64 !hurd-i386], libass-dev (>= 0.9.6), libavahi-client-dev, libavc1394-dev [!kfreebsd-i386 !kfreebsd-amd64 !hurd-i386], libavcodec-dev (>= 4:0.6), libavformat-dev (>= 4:0.6), libcaca-dev (>= 0.99.beta4), libcddb2-dev, libcdio-dev (>= 0.78.2), libdc1394-22-dev (>= 2.1.0) [!kfreebsd-i386 !kfreebsd-amd64 !hurd-i386], libdca-dev, libdirac-dev, libdvbpsi-dev | libdvbpsi5-dev, libdvdnav-dev, libdvdread-dev (>= 0.9.5), libfaad-dev, libflac-dev (>= 1.1.2-3), libfluidsynth-dev, libfreetype6-dev, libfribidi-dev, libggi2-dev, libgl1-mesa-dev, libglib2.0-0, libgnutls-dev (>= 1.7.4), libgtk2.0-dev, libjack-dev, libkate-dev (>= 0.1.5), liblircclient-dev, liblivemedia-dev (>= 2009.11.27), liblua5.1-0-dev, libmad0-dev, libmatroska-dev (>= 0.8.0), libmodplug-dev (>= 1:0.8.8.1), libmpcdec-dev, libmpeg2-4-dev, libmtp-dev (>= 1.0.0), libncursesw5-dev, libnotify-dev, libogg-dev, libpng12-dev, libpostproc-dev (>= 4:0.6), libproxy-dev, libpulse-dev (>= 0.9.11), libqt4-dev (>= 4.4.0), libraw1394-dev (>= 2.0.1) [!kfreebsd-i386 !kfreebsd-amd64 !hurd-i386], librsvg2-dev, libschroedinger-dev (>= 1.0.10), libsdl-image1.2-dev, libsdl1.2-dev (>= 1.2.10), libshout3-dev, libsmbclient-dev, libspeex-dev, libsvga1-dev [amd64 i386], libswscale-dev (>= 4:0.6), libtag1-dev (>= 1.5), libtar-dev, libtheora-dev, libtwolame-dev (>= 0.3.8), libudev-dev [!kfreebsd-i386 !kfreebsd-amd64 !hurd-i386], libupnp3-dev, libv4l-dev [!kfreebsd-i386 !kfreebsd-amd64 !hurd-i386], libva-dev [!kfreebsd-i386 !kfreebsd-amd64 !hurd-i386], libvcdinfo-dev (>= 0.7.22), libvorbis-dev, libx11-dev, libx11-xcb-dev, libx264-dev (>= 2:0.76), libxcb-keysyms1-dev (>= 0.3.4), libxcb-randr0-dev (>= 1.3), libxcb-shm0-dev, libxcb-xv0-dev (>= 1.1.90.1), libxcb1-dev, libxext-dev, libxml2-dev, libxpm-dev, libxt-dev, libzvbi-dev (>= 0.2.28), lua5.1, nasm, pkg-config, xulrunner-dev (>= 1.9.1), yasm [amd64 kfreebsd-amd64], zlib1g-dev
Checksums-Sha1: 
 cff81791d83fcd55f99cb12a4d9ad617cdff00c4 25333292 vlc_1.1.9.orig.tar.bz2
 bcbfb67939b32049f45633bc24e938e28b0eae3f 60232 vlc_1.1.9-1ubuntu1.1.debian.tar.gz
Checksums-Sha256: 
 f0bd71decbcdaaee7d8421039eddef503425059fd5460c7ef7e0b403bbcb2d0b 25333292 vlc_1.1.9.orig.tar.bz2
 81ae0aad0af9d24936ce0fe11efb9e032d235e52be0b4129f90708fe76eb4be0 60232 vlc_1.1.9-1ubuntu1.1.debian.tar.gz
Files: 
 06adb1848e6b87fbe1ced77ec0f91e4c 25333292 vlc_1.1.9.orig.tar.bz2
 f54d7a64c9d0229aa916ed32e3fd479d 60232 vlc_1.1.9-1ubuntu1.1.debian.tar.gz
Original-Maintainer: Debian multimedia packages maintainers <pkg-multimedia-maintainers@lists.alioth.debian.org>

-----BEGIN PGP SIGNATURE-----
Version: GnuPG v1.4.11 (GNU/Linux)


=G5uP
-----END PGP SIGNATURE-----
